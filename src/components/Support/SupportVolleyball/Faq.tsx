  ...
  return (
    <Accordion.Root className="faq" type="single" collapsible>
      <AccordionItem value="item-1">
        <AccordionTrigger>Как помочь команде кроме финансов?</AccordionTrigger>
        <AccordionContent>
          <ul className="list-disc pl-4">
            ...
            <li>
              <a href="mailto:vc@rwch.org">Предожениями</a>. Отправьте
      ...
      <AccordionItem value="item-2">
        ...
        <AccordionContent>
          Взносы за турниры, аренда зала для игр и тренировок, премии игрокам и
          тренерам, экипировка и тренировочный инвентарь, трансфер.
        </AccordionContent>
      </AccordionItem>
      ...
      <AccordionItem value="item-4">
        ...
        <AccordionContent>
          <ul className="list-disc pl-4">
            ...
            <li className="pb-2">
              Наименование команды в конкретном турнире вида: "RW" или "РВ" +
              ваше наименование.
            </li>
            <li className="pb-2">
